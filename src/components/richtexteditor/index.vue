...
<script>
  import {  Toolbar, Link,  Count, HtmlEditor, QuickToolbar } from "@syncfusion/ej2-vue-richtexteditor";
...
<template>
    ...
    import {  Toolbar, Link, Count, Image, HtmlEditor } from "@syncfusion/ej2-vue-richtexteditor";
