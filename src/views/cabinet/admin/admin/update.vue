<template>
    <CustomPagesCreate
      title="Admin"   pathToBack="/cabinet/admin/admin"
      @activeLangTab="(lang) => activeLang = lang"  @status="(status) => (form.status = status)"
    >
      <template #default>
        <el-form
          label-position="top"
          ...
          <el-row :gutter="20" :align="20">
            <el-col :span="24">
              <el-row :gutter="30">
                ...
                <el-col :md="4" :sm="6" :xs="12">
                  <el-form-item prop="is_staff">
                      <el-checkbox label="xodim" name="type" v-model="form.is_staff"/>
                  </el-form-item>
                </el-col>
                
                <el-col :md="4" :sm="6" :xs="12">
                  <el-form-item prop="is_superuser">
                      <el-checkbox label="admin" name="type" v-model="form.is_superuser"/>
                  </el-form-item>
                </el-col>
...
import { useRoute } from "vue-router";
  ...
  onMounted(async()=>{
     const res = await store.dispatch("admingetbyid",route.params.id);
     if(res.status){
